...
// Resolved from oq-api's published api/latest.json (v0.3.27). Use the GitHub
// Pages mirror because api.oq.gl is protected by Cloudflare WAF from CI.
const OQ_API_URL = "https://jandahl.github.io/api.oq.gl/api/v0.3.27/public-api.js";
...
export const {
	...
	conjugateSchwaStem,
	conjugateForm,
	// Have-N one-call transform (oq-api 0.3.27+): host N + optional count/howMany/intensifier +
	// -qaq + conjugation ending via buildWord. Never invents stems.
	// Returns { ok, word, phrase, numeral, seq, errorKey, missingIds, … }.
	haveNForm,
	HAVE_N_CARDINALS,
	HAVE_N_HOW_MANY,
	HAVE_N_MANY,
